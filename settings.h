...
#if (defined(ARDUINO_SAM_DUE) || defined(ARDUINO_SAMD_ZERO) || defined(ARDUINO_SAM_ZERO) || defined(RBL_NRF51822) || defined(__ARDUINO_X86__) || defined(__ARDUINO_ARC__) || ARDUINO >= 10600) && !USING_SPI4TEENSY3
